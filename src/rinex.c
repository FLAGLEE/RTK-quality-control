...
*
*-----------------------------------------------------------------------------*/
extern int readrnxt(const char* file, int rcv, gtime_t ts, gtime_t te,			//从RINEX文件中，读取指定时间段的观测数据和导航电文。
...
extern int readrnx(const char* file, int rcv, const char* opt, obs_t* obs,			//从RINEX文件中，读取观测数据和导航电文。
	nav_t* nav, sta_t* sta)
{
	gtime_t t = { 0 };
...
*-----------------------------------------------------------------------------*/
extern int readrnxc(const char* file, nav_t* nav)								//从RINEX文件中，读取时钟。
{
	gtime_t t = { 0 };
