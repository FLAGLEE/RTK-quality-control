                  ...
                  char *msg)
{
    ...
    satposs(sol->time,obs,n,nav,opt_.sateph,rs,dts,var,svh);							//卫星位置速度和钟差计算
    
    /* estimate receiver position with pseudorange */
    stat=estpos(obs,n,rs,dts,var,svh,nav,&opt_,ssat,sol,azel_,vsat,resp,msg);			//伪距单点定位
    ...
    if (stat) estvel(obs,n,rs,dts,nav,&opt_,sol,azel_,vsat);							//计算接收机速度
